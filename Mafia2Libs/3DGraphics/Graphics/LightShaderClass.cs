...
namespace ModelViewer.Programming.GraphicClasses
{
    public class LightShaderClass
    {
        ...
        private bool SetShaderParameters(DeviceContext deviceContext, Matrix WorldMatrix, Matrix ViewMatrix, Matrix ProjectionMatrix, ShaderResourceView texture, Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColour, Vector3 cameraPosition, Vector4 specularColor, float specularPower)
        {
            try
            {
