    ...
    public class TextureShaderClass
    {
        ...
        private bool InitShader(Device device, IntPtr WindowsHandle, string vsFileName, string psFileName)
        {
            try
            {
                ...
                vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "TextureVertexShader", "vs_5_0", ShaderFlags.None, EffectFlags.None);
                pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "TexturePixelShader", "ps_5_0", ShaderFlags.None, EffectFlags.None);
