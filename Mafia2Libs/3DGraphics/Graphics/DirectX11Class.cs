...
namespace ModelViewer.Programming.GraphicClasses
{
    public class DirectX11Class
    {
        ...
        {
            VerticalSyncEnabled = ToolkitSettings.VSync;
            ...
            var swapChainDesc = new SwapChainDescription()
            {
                ...
                IsWindowed = !ToolkitSettings.Fullscreen,
            ...
            ProjectionMatrix = Matrix.PerspectiveFovLH((float)(Math.PI / 4), (float)ToolkitSettings.Width / ToolkitSettings.Height, ToolkitSettings.ScreenNear, ToolkitSettings.ScreenDepth);
