...
namespace ModelViewer.Graphics
{
    public class DirectX11Class
    {
        ...
        public bool Init(SystemConfigClass Config, IntPtr WindowHandle)
        {
            ...
            ProjectionMatrix = Matrix.PerspectiveFovLH((float)(Math.PI / 4), ((float)Config.Width / (float)Config.Height), SystemConfigClass.ScreenNear, SystemConfigClass.ScreenDepth);
