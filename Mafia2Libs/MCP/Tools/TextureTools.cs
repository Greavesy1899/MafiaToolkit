...
public class TextureTools
{
    ...
    private static DdsInfo? ParseDdsHeader(byte[] data)
    {
        ...
        var info = new DdsInfo
        {
            ...
            MipCount = BitConverter.ToUInt32(data, 28)
        };
    ...
    private static string FourCCToString(uint fourCC) => fourCC switch
    {
        0x31545844 => "DXT1",
        0x32545844 => "DXT2",
        0x33545844 => "DXT3",
    ...
    private static string GetDX10FormatName(uint format) => format switch
    {
    ...
    private static string GetFormatDetails(string format) => format switch
    {
