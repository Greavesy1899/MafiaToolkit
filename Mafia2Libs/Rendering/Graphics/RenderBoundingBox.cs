...
namespace ModelViewer.Programming.GraphicClasses
{
    public class RenderBoundingBox
    {
        ...
        public bool Init(BoundingBox bbox)
        {
            ...
            Vertices[1].texture = new Vector2(0.0f, 1.0f);
            ...
            Vertices[4].texture = new Vector2(0.0f, 1.0f);
            ...
            Vertices[5].texture = new Vector2(0.0f, 1.0f);
            ...
            Vertices[6].texture = new Vector2(0.0f, 1.0f);
            ...
            Vertices[7].texture = new Vector2(0.0f, 1.0f);
