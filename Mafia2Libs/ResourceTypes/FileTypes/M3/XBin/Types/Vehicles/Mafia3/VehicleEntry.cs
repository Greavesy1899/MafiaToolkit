...
{
    public class VehicleTableItem_M3 : IVehicleTableItem
    {
        public int Unk0 { get; set; }
        [PropertyForceAsAttribute]
        public int ID { get; set; }
        [Editor(typeof(FlagEnumUIEditor), typeof(UITypeEditor))]
        public ETrafficCommonFlags_M3 CommonFlags { get; set; } //E_TrafficCommonFlags
        [Editor(typeof(FlagEnumUIEditor), typeof(UITypeEditor))]
        ...
        public void ReadEntry(BinaryReader reader)
        {
            ...
            ID = reader.ReadInt32();
            CommonFlags = (ETrafficCommonFlags_M3)reader.ReadInt32();
            VehicleFlags = (ETrafficVehicleFlags_M3)reader.ReadInt32();
            VehicleLookFlags = (ETrafficVehicleLookFlags_M3)reader.ReadInt32();
