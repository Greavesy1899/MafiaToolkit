...
namespace ResourceTypes.Cutscene.CurveParams
{
    ...
    public class EffectActionParam : ICurveParam
    {
        public EffectActionParam()
        {

        }

        public EffectActionParam(BinaryReader br)
        {
            Read(br);
        }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class EffectAction : EffectActionParam
    {
        [TypeConverter(typeof(ExpandableObjectConverter))]
        ...
        public EffectAction(BinaryReader br)
        {
            Read(br);
        }
